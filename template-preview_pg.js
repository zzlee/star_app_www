...
//        recordUserAction("enters template_previewPg");
    ...
    init : function() {
        ...
        /* ends of §Êñ∑â‰‰∏ÄÊ≠•ËûÂì™‰∏Ä*/
    
        
        /* preview page title bar text ÂΩ±ÁπÂÖ∂‰ªñ‰‰∏ÄÊ®/
        if(FmMobile.selectedTemplate == 'miix_it'){
            $('.header-text').html("áÁÖßÊ®°Êì¨êË¶Ω");
            $('#afterSendText').html('â‰Á¢∫Âï‰ª∂Âæ®ÂÉÊî∂∞APPÑÊé®öÁü•®ÊòØÆÂÁ¨¨Âπæ‰ΩçË©¶°ËÄÖ„ÄÇËã•Â∞éÊÊ±∫ÂäÁôª®Á‰ΩúÂ,®Ê∂Âà∞APPÑÊé®≠ËfacebookêÂ,öÁü•ªÂ†¥•ÊÇÈÇÂÈ°çÁÂ∞Â∞éÊ™ÂëÈÅ∏µÊ‰ΩúÂ);
        }else if(FmMobile.selectedTemplate == 'check_in'){
            $('#clickImgEffect').html("ÈªûÊØÊîæÂ§);
            $('#afterSendText').html('â‰Á¢∫Âï‰ª∂ÂæôÂºµ‰ΩúÂÂ∞áÊº‰ºÊÇ®ÑfacebookÇÊ≠§Â§ñÊÇ®Â∞áÊ∂Âà∞APPÑÊé®öÁü•ØÁõÆçÁ¨¨Âπæ‰Ë©¶Èè°Ö„ÄÇËã•Â∞éÊÊ±∫ÂäÁôª®Á‰ΩúÂ, ®Ê∂Âà∞APPÑÊé®≠ËfacebookêÂ,öÁü•ªÂ†¥üÊì„ÄÇÂÈ°çÁÂ∞Â∞éÊ™ÂëÈÅ∏µÊ‰ΩúÂ);
        }
        else{
            $('#clickImgEffect').html('ÈªûÊØÊîæÂ§);
             $('#afterSendText').html('â‰Á¢∫Âï‰ª∂Âæ®ÂÉÊî∂∞APPÑÊé®öÁü•®ÊòØÆÂÁ¨¨Âπæ‰ΩçË©¶°ËÄÖ„ÄÇËã•Â∞éÊÊ±∫ÂäÁôª®Á‰ΩúÂ,®Ê∂Âà∞APPÑÊé®≠ËfacebookêÂ,öÁü•ªÂ†¥•ÊÇÈÇÂÈ°çÁÂ∞Â∞éÊ™ÂëÈÅ∏µÊ‰ΩúÂ');
        }
       /* ends of preview page title bar text ÂΩ±ÁπÂÖ∂‰ªñ‰‰∏ÄÊ®/
