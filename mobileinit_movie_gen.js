...
var mobileinitForMovieGen = function() {
    ...
    //$("#photoCropperPg").live("pageinit", FmMobile.photoCropperPg.image_ini);
    //$("#photoCropperPg").live("pageshow", FmMobile.photoCropperPg.image_event);
...
FmMobile.photoCropperPg = {
    ...
    //JF: image_ini, image_event
    image_ini: function(event, data){
	...
	onOkBtnClick: function() {
        ...
        //JF
        //photoCroppedURI = canvas.toDataURL();
        //$.mobile.changePage("movie_preview.html");
